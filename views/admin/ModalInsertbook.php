    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="insertBookForm" action="index.php?action=insertBook" method="post"  enctype="multipart/form-data">
                    <div class="mb-3">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" form="insertBookForm" class="btn btn-primary">Insertar libro</button>
            </div>
        </div>
    </div>
</div>